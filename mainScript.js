    ...
    card.innerHTML = `
      <div class="p-5">
        ...
        <div class="flex flex-wrap gap-1 mb-6">
              ...
              <span
                class="badge badge-sm bg-red-50 text-red-500 border-none text-[10px] font-bold"
                >BUG</span
              >
              <span
                class="badge badge-sm bg-orange-50 text-orange-500 border-none text-[10px] font-bold"
                >HELP WANTED</span
              >
            </div>
        </div>
